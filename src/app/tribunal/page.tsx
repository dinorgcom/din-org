...
export const metadata: Metadata = {
  title: "din.org Tribunal — AI Arbitration & Online Dispute Resolution",
  description:
    "The din.org Tribunal: end-to-end AI arbitration. File a case, present evidence, examine witnesses by AI-led video, receive a reasoned ruling — with human-judge appeal panels built in. Operated on the same decision endpoint we sell.",
  alternates: {
  ...
  openGraph: {
    ...
    title: "din.org Tribunal — AI Arbitration & Online Dispute Resolution",
    description:
      "End-to-end AI arbitration. The tribunal din.org runs on its own decision endpoint.",
